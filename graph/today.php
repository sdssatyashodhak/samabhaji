<?php
$url_one = "http://finance.google.com/finance/info?client=ig&q=NSE:NIFTY,INDEXBOM:SENSEX";
$ch_one = curl_init();
...
$final_stock_result=(array)$result_one;
$response1["market"] = array(); 
foreach ($final_stock_result as $response)
{
  ...
  array_push($response1["market"], $user); 
}
